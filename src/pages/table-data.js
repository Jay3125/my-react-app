...
import hindi from '../vendor/language/french.json'
          ...
          <p className="mb-3">Images in Bootstrap are made responsive with <code>.img-fluid</code>. <code>max-width: 100%;</code> and <code>height: auto;</code> are applied to the image so that it scales with the parent element.</p>
              <div className="table-responsive">
                <select id="langSelector" className="form-control mb-3">
                  <option id="german" value="german" data-path="../../public/vendor/language/german.json">German</option>
                  <option id="french" value="french" data-path={hindi}>French</option>
                  <option id="hindi" value="hindi" data-path="../../public/vendor/language/hindi.json">Hindi</option>
                  <option id="japanase" value="japanase" data-path="../../public/vendor/language/japanese.json">Japanese</option>
                  <option id="english" value="eng" data-path="../../public/vendor/language/english.json">English</option>
                </select>            
              <div>
               {/* datatable  */}
